    ...
    >
      <div className="max-w-6xl mx-auto px-8 pb-16">
        <motion.div className="grid grid-cols-12 gap-8 items-start" variants={itemVariants}>
          <motion.section className="col-span-7 surface-light rounded-[28px] p-10" variants={itemVariants}>
            <div className="text-xs uppercase tracking-[0.4em] text-[var(--ui-accent)] font-semibold">
              Zhou Wen Wang
            </div>
            <h1 className="mt-4 text-4xl md:text-5xl font-semibold text-ink lux-title">
              周文王占卜
            </h1>
            ...
            <div className="mt-8 flex items-center gap-4">
              <motion.button
                ...
                className="bg-[var(--ui-accent)] text-white px-8 py-3 rounded-xl font-semibold text-base hover:bg-[var(--ui-accent-strong)] transition-all duration-300 shadow-[0_12px_30px_rgba(37,94,234,0.25)]"
          ...
          <motion.section className="col-span-5 space-y-6" variants={itemVariants}>
            <div className="surface-dark rounded-3xl p-6">
                ...
                {games.map(game => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl border border-[var(--ui-border)] hover:border-[var(--ui-accent)] hover:bg-[var(--ui-surface-3)] transition-all"
