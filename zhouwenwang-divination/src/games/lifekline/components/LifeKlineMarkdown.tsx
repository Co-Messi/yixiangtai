    ...
    <div className="life-kline-markdown">
      <ReactMarkdown
        ...
        components={{
          // 标题样式 - 使用绿色主题
          h1: ({ children }) => (
            <h1 className="text-2xl font-bold text-[var(--ui-success)] mb-4 mt-6 first:mt-0 border-b border-[var(--ui-border)] pb-2">
              {children}
            </h1>
          ),
          h2: ({ children }) => (
            <h2 className="text-xl font-bold text-[var(--ui-success)] mb-3 mt-5 first:mt-0">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
          ...
          h4: ({ children }) => (
            <h4 className="text-base font-semibold text-[var(--ui-success)] mb-2 mt-3 first:mt-0">
              {children}
            </h4>
          ),
          ...
          li: ({ children }) => (
            <li className="text-[var(--ui-muted-2)] leading-relaxed flex items-start">
              <span className="text-[var(--ui-success)] mr-2 mt-1">•</span>
          ...
          // 强调样式
          strong: ({ children }) => (
            <strong className="font-bold text-[var(--ui-success)]">
              {children}
            </strong>
          ),
          em: ({ children }) => (
          ...
          code: ({ children, className }) => {
            ...
            return isInline ? (
              <code className="bg-[var(--ui-surface-3)] text-[var(--ui-success)] px-1.5 py-0.5 rounded text-sm font-mono border border-[var(--ui-muted)]">
                {children}
              </code>
            ) : (
          ...
          // 引用样式
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-[var(--ui-success)] pl-4 my-4 text-[var(--ui-muted-2)] italic bg-[var(--ui-surface-2)] py-2 rounded-r-lg">
              {children}
            </blockquote>
          ),
          ...
          // 水平分割线
          hr: () => (
            <hr className="border-0 h-px bg-gradient-to-r from-transparent via-[var(--ui-success)] to-transparent my-6" />
          ),
          ...
          th: ({ children }) => (
            <th className="border border-[var(--ui-muted)] bg-[var(--ui-surface-3)] text-[var(--ui-success)] px-4 py-2 text-left font-semibold">
              {children}
            </th>
          ),
          td: ({ children }) => (
          ...
          a: ({ children, href }) => (
            <a 
              href={href} 
              className="text-[var(--ui-success)] hover:text-[var(--ui-success)] underline transition-colors duration-200"
              target="_blank"
